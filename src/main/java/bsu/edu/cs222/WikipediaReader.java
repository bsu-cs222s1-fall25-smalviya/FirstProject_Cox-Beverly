...
public class WikipediaReader {
    ...
    public static String read(String title) {
        try {
            ...
            throw new RuntimeException("Unable to connect to Wikipedia. Check your internet connection.");
        } catch (IOException e) {
            throw new RuntimeException("Failed to fetch article: " + title + " (" + e.getMessage() + ")");
        } catch (Exception e) {
